...
This repository is a notebook-driven labor-policy analysis workspace focused on early termination of emergency unemployment benefits and employment or job-finding outcomes, with particular attention to low-wage workers.
...
- Best-supported saved DDD results: [notebooks/SignificanceHolzerStyle.ipynb](/Users/jomus/Code/capstone/notebooks/SignificanceHolzerStyle.ipynb).
- Baseline TWFE reference: [baseline_model.ipynb](/Users/jomus/Code/capstone/baseline_model.ipynb).
- Exploratory sensitivity stack: [archive/notebooks/FirstValidTimeFrame.ipynb](/Users/jomus/Code/capstone/archive/notebooks/FirstValidTimeFrame.ipynb), [archive/notebooks/Significant.ipynb](/Users/jomus/Code/capstone/archive/notebooks/Significant.ipynb), and related archived variants.

## Repo Layout

- `data/raw/`: raw policy, COVID, employment, OxCGRT, and CPS CSV inputs committed to the repo.
...
- Local input copies exist in `data/raw/`, including policy, COVID, employment, and a large CPS extract used by the final notebook.
...
- The original README linked an external CPS file:
...
1. Review [docs/RESEARCH_READINESS.md](/Users/jomus/Code/capstone/docs/RESEARCH_READINESS.md) to see which notebooks are closest to a defensible analysis path.
2. Review [docs/ROBUSTNESS_PLAYBOOK.md](/Users/jomus/Code/capstone/docs/ROBUSTNESS_PLAYBOOK.md) before presenting or writing up results.
3. Use [notebooks/SignificanceHolzerStyle.ipynb](/Users/jomus/Code/capstone/notebooks/SignificanceHolzerStyle.ipynb) as the current best-supported source for the main DDD, placebo, and leave-one-state-out results.
4. Use [baseline_model.ipynb](/Users/jomus/Code/capstone/baseline_model.ipynb) for baseline TWFE context.
5. Treat notebooks under [archive/notebooks/README.md](/Users/jomus/Code/capstone/archive/notebooks/README.md) as exploratory history, not the primary analysis path.
